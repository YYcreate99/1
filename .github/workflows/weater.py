...
SCKEY='SCT159668TAFmUzxrV6ihGVAaI1q0n6zhC'  #通过 http://sc.ftqq.com/?c=code 获取
...
def ServerPush(info): #Server酱推送
   # api = "sct.ftqq.com/{}.send".format(SCKEY)
   api="https://sctapi.ftqq.com/SCT159668TAFmUzxrV6ihGVAaI1q0n6zhC.send"
    title = u"天气推送"
...
def main():
    try:
        ...
        city_code = '101210401'   #进入https://where.heweather.com/index.html查询你的城市代码
        tqurl = api + city_code
